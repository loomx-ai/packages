...
The hourly publisher detects new prereleases and assets added to an existing
release as well as stable releases. All download files remain on GitHub Releases;
the download history is available at [loomx.ai/steward/downloads](https://loomx.ai/steward/downloads).
